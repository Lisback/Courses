...
class GestionnaireCoursesApp:
    def __init__(self, root):
        ...
        self.entry_nom.insert(0, "Nom de l'article")
    ...
    def ajouter_article(self):
        ...
        if nom:
            if quantite.isdigit():
                ...
                messagebox.showwarning("Attention", "Veuillez entrer une quantité valide.")
                return
    ...
    def charger_courses(self):
        try:
            ...
            messagebox.showerror("Erreur", f"Une erreur est survenue lors du chargement : {e}")
            self.courses = []
